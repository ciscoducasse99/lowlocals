        ...
        return (
            <div style={{backgroundColor:"white"}}>
                <Navbar
                  ...
                  style={{
                    borderBottom:"0 .5rem 1rem rgba(0,0,0,.15)!important"
                  }}>
                    <Container>
                        <NavbarBrand className="mr-auto">Locals</NavbarBrand>
                        <i
                          onClick={this.toggle}
                          className="ml-auto far fa-2x fa-question-circle btn-circle"
                        />
                    </Container>
